...
class LogScaleInterp {
   ...
   private:
    double log_r_lo{0};  // Lower boundary of logarithmic radius
    double log_r_hi{0};  // Upper boundary of logarithmic radius

    double log_t_lo{0};  // Lower boundary of logarithmic observation time
    double log_t_hi{0};  // Upper boundary of logarithmic observation time

    double log_d_lo{0};  // Lower boundary of logarithmic Doppler factor
    double log_d_hi{0};  // Upper boundary of logarithmic Doppler factor

    double log_I_lo{0};  // Lower boundary of logarithmic intensity
    double log_I_hi{0};  // Upper boundary of logarithmic intensity
...
class Observer {
   public:
    ...
    double theta_obs{0};    // Observer's theta angle
    double lumi_dist{1};    // Luminosity distance
    double z{0};            // Redshift
