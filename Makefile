...
CXXFLAG     := -std=c++20 -flto -Iinclude -Iexternal -g -lz -O3 -w -DNDEBUG -DXTENSOR_DISABLE_ASSERT -DXTENSOR_DISABLE_CHECK_DIMENSION -DXTENSOR_DISABLE_CHECK_SHAPE #-DXTENSOR_USE_XSIMD=ON#-DEXTREME_SPEED 
