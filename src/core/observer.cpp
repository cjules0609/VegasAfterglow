...
Real LogScaleInterp::interp_luminosity(Real t_obs, Real t_lo, Real surface_lo) const noexcept {
    Real log_t = fast_log2(t_obs / t_lo);
    return surface_lo * fast_exp2(log_I_lo + log_t * slope);
}
