...
void output(MeshGrid3d const& array, std::string const& filename, double unit);  // Outputs a 3D MeshGrid with a unit.
void output(MeshGrid const& grid, std::string const& filename, double unit);     // Outputs a 2D MeshGrid with a unit.
void output(Array const& array, std::string const& filename, double unit);       // Outputs a 1D Array with a unit.
